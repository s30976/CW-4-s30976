...
public class AdvancedEmpDeptTests
{
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        bool result = emps.All(e => e.Sal > 500);
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        bool result = emps.Any(e => e.Comm > 400);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            .Join(emps, e1 => e1.Mgr, e2 => e2.EmpNo,
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            .Join(depts, 
                e => e.DeptNo,
                d => d.DeptNo,
                (e, d) => new { e.EName, d.DName, e.Sal, e.DeptNo })
            .SelectMany(
                ed => grades.Where(g => ed.Sal >= g.Losal && ed.Sal <= g.Hisal),
                (ed, g) => new { ed.EName, ed.DName, Grade = g.Grade })
            .ToList();
